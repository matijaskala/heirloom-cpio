...
extern enum pax {			/* type of pax command this is */
...
extern void	pax_flags(int ac, char **av);
extern void	pax_usage(void);
extern void	cpio_flags(int ac, char **av);
extern void	cpio_usage(void);
